...
\leftline{{\bf Office Hours:} Mondays 2:30--3:20pm}
...
\paragraph*{Class Location:} \href{https://library.mcmaster.ca/cct/class-dir/etb-237}{Engineering Technology Building (ETB) 237}

\paragraph*{Class Times:}
\begin{itemize}\addtolength{\itemsep}{-0.75\baselineskip}
\item Mondays 11:30am -- 2:20pm
