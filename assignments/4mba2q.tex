...
\begin{tabular}{r p{4.25in}}
     ...
     \code{vars} & A named vector of the variables in the system (\eg $S$, $I$).  The variables, passed to this function as a named vector, are used in the code that defines the vector field within the function. \\
