...
%% This distributed template is self-contained; its year therefore mirrors
%% the authoritative value in ../4mb_term_metadata.tex rather than importing it.
