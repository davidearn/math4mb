...
Don't worry if your expression contains an integral that cannot be expressed in terms of elementary functions.
}
...
Prove that all solutions of the basic SIR model approach $I=0$ asymptotically.\\\emph{Hint:} Is the function $L(S,I)=I$ a Lyapunov function?  Read the \hyperlink{NotesLyapFuns}{Notes on Lyapunov functions} below.
}
