...
### OS X
[http://aquamacs.org Aquamacs] is a good graphical version of Emacs for OS X, but you can just also run the command '''emacs''' from a Terminal or XQuartz window.
